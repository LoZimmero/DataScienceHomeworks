...
class FeedforwardNN():
    ...
    def __init__(self, input_dim):
        ...
        hidden_layer = Dense(32,activation='tanh',kernel_initializer=RandomNormal())(input_layer)  # Con quesata sintassi sitamo dicendo che colleghiamo questo layer a input_layer
        hidden_layer_2 = Dense(2,activation='relu',kernel_initializer=RandomNormal())(hidden_layer)  # Con quesata sintassi sitamo dicendo che colleghiamo questo layer a input_layer
        output_layer = Activation(activation='softmax')(hidden_layer_2)
